...
stormwater <- st_read("data/NYC Stormwater Flood Map - Extreme Flood.gdb", layer = "NYC_Stormwater_Flood_Map_Extreme_Flood") %>% 
  st_transform(crs = 4326)
...
unzip(
  zipfile = "data/NFHL_36_20211216.zip",
  exdir = "data/NFHL"
)

ogrListLayers("C:/Users/zheng/Desktop/670 DS/FinalProject/data/NFHL/NFHL_36_20211216.gdb")

NFHL <- st_read("data/NFHL/NFHL_36_20211216.gdb", layer = "S_FLD_HAZ_AR") %>% 
  st_transform(crs = 4326)
...
NYC_boundary <- st_union(geo) %>% 
  st_as_sf(crs = 4326)

sf_use_s2(FALSE)
NFHL_NYC <- st_filter(NFHL, NYC_boundary)
