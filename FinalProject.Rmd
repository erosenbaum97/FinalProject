...
floodtracts <- st_join(geo,floodplain100, join = st_intersects, left = FALSE)
...
demogdatafloodboro %>%
  ...
  summarize_at(vars("employed", "poverty", "high_school", "white"), mean)

# applies model to testing data and codes probabilities as 0 or1 
predictionslg <- predict(logreg, floodtracts_test)
binarypreds <- ifelse(predictionslg > 0.5, 1, 0)
